#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Modified to be compatible with Chinese utterance ID, wbjiang, 2024-08
...
if os.environ['KALDI_ROOT'] and not os.path.exists(os.environ['KALDI_ROOT']):
...
def open_or_fd(file, mode='rb'):
    ...
    if offset is not None: fd.seek(int(offset))
    return fd
