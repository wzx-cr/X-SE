...
class KaldiLRScheduler(LRScheduler):
    ...
    def __init__(self, optimizer, warmup_round=200, warmup_batches_per_round=20, rel_stop=0.001, rel_decay=0.005):
    ...
    def _step(self):
        ...
        if self._step_count >= self.warmup_batches_per_round * self.warmup_round:
            ...
            warmup_rd = self._step_count // self.warmup_batches_per_round + 1
